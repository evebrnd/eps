...
export default function Page() {
  return (
    <div className="flex flex-col justify-center py-2 mx-4 md:mx-12">
      ...
      <h1 className="flex justify-center text-center mt-5 text-4xl font-extrabold tracking-tight lg:text-5xl">
        Opinion of the general public on SHD and studies
      </h1>

      <p className="leading-7 mt-10 text-pretty mx-auto w-5/6 md:w-3/6">
      ...
      <div className="flex flex-col text-justify mx-auto w-5/6 md:w-3/6 py-3 border-y-2 border-primary/20 mt-10">
        ...
        <h3 className="mt-8 text-3xl font-semibold tracking-tight pt-10 border-t-2 border-primary/20">
          3.2. The EPS project survey
        </h3>
        ...
        <h3 className="mt-8 text-2xl font-bold tracking-tight">How would you rate your knowledge of smart home devices?</h3>
        <p className="leading-7">INSERT GRAPHIC</p>

        <h3 className="mt-8 text-2xl font-bold tracking-tight">Do you own a smart home device?</h3>
        <p className="leading-7">INSERT GRAPHIC</p>

        <h3 className="mt-8 text-2xl font-bold tracking-tight">What smart home device(s)?</h3>
        ...
        <h3 className="mt-8 text-2xl font-bold tracking-tight">When thinking of smart home devices, which one comes to mind first?</h3>
        ...
        <h3 className="mt-8 text-2xl font-bold tracking-tight">Do you know if there is AI in any smart home device you use? & Specify which device?</h3>
        <p className="leading-7">INSERT GRAPHIC</p>
        ...
        <h3 className="mt-8 text-2xl font-bold tracking-tight">If you were to buy a smart home device, would you rather put your trust in a big company (Google, Amazon, etc.) or in a small company?</h3>
        ...
        <h3 className="mt-8 text-2xl font-bold tracking-tight">Summary</h3>
