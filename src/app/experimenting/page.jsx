...
// import importedAnnotatedPDF from '../../Annotated_Bibliography.pdf'
    ...
    return (
        <div className='flex flex-col'>
            ...
            <object data="../../Annotated_Bibliography.pdf" type="application/pdf" height="500px" width="100%">
                <p>Unable to display PDF file. <a href="../../Annotated_Bibliography.pdf" download="Example-PDF-Document" target='_blank' rel='noreferrer'>Download</a> instead.</p>
            </object>
            {/* </div> */}
            {/* </div> */}
        </div>
